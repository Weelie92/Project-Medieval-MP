...
namespace Rowlan.Yapp
{
    public class SplineModuleEditor: ModuleEditorI
    {
        ...
        public void OnInspectorGUI()
        {
            ...
            else if (editorTarget.splineSettings.separation == SplineSettings.Separation.PrefabRightSize)
            {
                EditorGuiUtilities.MinMaxEditor("  Distance Min", ref separationDistanceMin, "  Distance Max", ref separationDistanceMax);
            }
            else if (editorTarget.splineSettings.separation == SplineSettings.Separation.PrefabUpSize)
            {
                EditorGuiUtilities.MinMaxEditor("  Distance Min", ref separationDistanceMin, "  Distance Max", ref separationDistanceMax);
            }
