        ...
        public struct RPGCharacterActions
        {
            ...
            public void SetCallbacks(IRPGCharacterActions instance)
            {
                if (m_Wrapper.m_RPGCharacterActionsCallbackInterface != null)
                {
                    ...
                    @ToggleHeadLook.started -= m_Wrapper.m_RPGCharacterActionsCallbackInterface.OnToggleHeadLook;
                    @ToggleHeadLook.performed -= m_Wrapper.m_RPGCharacterActionsCallbackInterface.OnToggleHeadLook;
                    @ToggleHeadLook.canceled -= m_Wrapper.m_RPGCharacterActionsCallbackInterface.OnToggleHeadLook;
                    @ToggleInjury.started -= m_Wrapper.m_RPGCharacterActionsCallbackInterface.OnToggleInjury;
                    @ToggleInjury.performed -= m_Wrapper.m_RPGCharacterActionsCallbackInterface.OnToggleInjury;
                    @ToggleInjury.canceled -= m_Wrapper.m_RPGCharacterActionsCallbackInterface.OnToggleInjury;
                    @TogglePause.started -= m_Wrapper.m_RPGCharacterActionsCallbackInterface.OnTogglePause;
                    @TogglePause.performed -= m_Wrapper.m_RPGCharacterActionsCallbackInterface.OnTogglePause;
                    @TogglePause.canceled -= m_Wrapper.m_RPGCharacterActionsCallbackInterface.OnTogglePause;
                    @ToggleSlowTime.started -= m_Wrapper.m_RPGCharacterActionsCallbackInterface.OnToggleSlowTime;
                    @ToggleSlowTime.performed -= m_Wrapper.m_RPGCharacterActionsCallbackInterface.OnToggleSlowTime;
                    @ToggleSlowTime.canceled -= m_Wrapper.m_RPGCharacterActionsCallbackInterface.OnToggleSlowTime;
                }
