...
namespace JUEditor
{
    public static class CustomEditorStyles
    {
        ...
        {
            GUIStyle DangerButton = new GUIStyle(EditorStyles.miniButtonMid);
            DangerButton.font = JUEditorFont();
        ...
        public static GUIStyle Title()
        {
            ...
            titleStyle.font = JUEditorFont();
            titleStyle.fontSize = 18;
            titleStyle.fontStyle = FontStyle.Bold;
            titleStyle.alignment = TextAnchor.MiddleLeft;
            return titleStyle;
        }
        public static GUIStyle TextWithFont(bool Bold)
        {
            GUIStyle titleStyle = new GUIStyle(EditorStyles.label);
            //titleStyle.normal.textColor = new Color(1, 1, 1, 1F);
            titleStyle.font = JUEditorFont();
        ...
        public static GUIStyle TextWithoutFont(bool Bold)
        {
            GUIStyle titleStyle = new GUIStyle(EditorStyles.label);
            //titleStyle.normal.textColor = new Color(1, 1, 1, 1F);
            titleStyle.fontSize = 14;
        ...
        public static Font JUEditorFont()
        {
            Font font = AssetDatabase.LoadAssetAtPath<Font>("Assets/JU Foot Placement/Editor/Resources/Fonts/Hyperjump Bold.otf");
            return font;
        }
    }
    public static class CustomEditorUtilities
    {
        ...
        public static void JU_AssetTitle(string TitleName = "")
        {

            if (logo == null)
            {
                logo = GetImage("Assets/JU Foot Placement/Textures/Editor/JUFOOTPLACEMENTLOGOResized.png");
                return;
            }
            else
            {
