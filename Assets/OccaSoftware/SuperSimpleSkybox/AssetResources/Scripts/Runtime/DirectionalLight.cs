...
namespace OccaSoftware.SuperSimpleSkybox.Runtime
{
    ...
    [AddComponentMenu("SuperSimpleSkybox/DirectionalLight")]
	...
	public class DirectionalLight : MonoBehaviour
    {
        ...
        /// </summary>
        public LightState State { get => state; }
        ...
        private void Rotate()
        {
			...
			transform.Rotate(transform.right * rotationsPerHour * Time.deltaTime * 0.1f, Space.World);
		}
