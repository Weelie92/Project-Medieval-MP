...
namespace OccaSoftware.Buto.Editor
{
    ...
    public class FogDensityMaskEditor : UnityEditor.Editor
    {
		...
		public override void OnInspectorGUI()
		{
            ...
            EditorGUILayout.PropertyField(Props.blendDistance, new GUIContent("Blend Distance", "Set the distance from the mask's edge at which mask will take full effect. For example, a value of 1 indicates that the mask will take full effect 1 unit outside of the mask bounds."));
