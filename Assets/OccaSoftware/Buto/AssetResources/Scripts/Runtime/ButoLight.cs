...
namespace OccaSoftware.Buto
{
    ...
    public sealed class ButoLight : ButoPlaceableObject
    {
        ...
        [SerializeField] [ColorUsage(false, false)] private Color lightColor = Color.white;
        ...
        public Vector3 LightDirection
		{
			get
			{
                return -transform.localToWorldMatrix.GetColumn(2);
        ...
        public Vector3 LightPosition
		{
			get
			{
                return transform.localToWorldMatrix.GetColumn(3);
			}
		}
