...
//     version 1.5.1
//     from Assets/0_Scripts/Characters/Player/PlayerControls/PlayerControls.inputactions
//
...
public partial class @PlayerControls: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""New action"",
                    ""type"": ""Button"",
                    ""id"": ""ed42b6cf-ab9f-4b01-bba0-0a56d3bf740f"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": ""Controller"",
                    ""id"": ""1fb8a9ed-f028-4bcb-8e64-a3951e8bc382"",
                    ""path"": ""2DVector"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""up"",
                    ""id"": ""f349e183-6273-4840-805f-e88dbc660b1d"",
                ...
                {
                    ""name"": ""down"",
                    ""id"": ""0f8b050e-3c5f-4f4d-9478-0ece44cc3915"",
                ...
                {
                    ""name"": ""left"",
                    ""id"": ""0a913c4d-4609-409c-8564-b9f4d72715b6"",
                ...
                {
                    ""name"": ""right"",
                    ""id"": ""e82a02b4-fec3-4b9c-ba8f-c776110b41f4"",
                ...
                {
                    ""name"": """",
                    ""id"": ""1b30c285-0fe3-4bd5-9e32-7d8d505a36af"",
                ...
                {
                    ""name"": """",
                    ""id"": ""e82ef43c-965d-4f8f-88c4-28820572dbc0"",
                    ""path"": """",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    private List<ICustomizeActions> m_CustomizeActionsCallbackInterfaces = new List<ICustomizeActions>();
    ...
    public struct CustomizeActions
    {
        ...
        public void AddCallbacks(ICustomizeActions instance)
        {
            if (instance == null || m_Wrapper.m_CustomizeActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_CustomizeActionsCallbackInterfaces.Add(instance);
        ...
        private void UnregisterCallbacks(ICustomizeActions instance)
        {
            @Close.started -= instance.OnClose;
            @Close.performed -= instance.OnClose;
            @Close.canceled -= instance.OnClose;
        ...
        public void RemoveCallbacks(ICustomizeActions instance)
        {
            if (m_Wrapper.m_CustomizeActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(ICustomizeActions instance)
        {
            foreach (var item in m_Wrapper.m_CustomizeActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_CustomizeActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
