...
public class PmGameMultiplayer : NetworkBehaviour
{
    ...
    private void NetworkManager_ConnectionApprovalCallback(NetworkManager.ConnectionApprovalRequest connectionApprovalRequest, NetworkManager.ConnectionApprovalResponse connectionApprovalResponse)
    {
        if (SceneManager.GetActiveScene().name != Loader.Scene.LobbyReadyScene.ToString())
        {
            ...
            connectionApprovalResponse.Reason = "Denied: Not in LobbyReadyScene";
            return;
        }
        ...
        {
            connectionApprovalResponse.Approved = false;
            connectionApprovalResponse.Reason = "Denied: Max player amount reached";
            return;
        }

        connectionApprovalResponse.Approved = true;
        connectionApprovalResponse.Reason = "Approved";
    }
